...
<%@ page import="java.util.List, entity.Brand" %>
...
<html lang="vi">
    ...
    <body>
        <div class="admin-wrapper">
            <h1>Brand List</h1>
            <a href="<%= request.getContextPath() %>/brandForm" class="action-link">Add New Brand</a>
            <table>
                <tr>
                    <th>ID</th>
                    <th>Brand Name</th>
                ...
                <tr>
                    ...
                    <td class="action-buttons">
                        <a href="<%= request.getContextPath() %>/brandForm?id=<%= b.getBrandId() %>">Edit</a> |
                        <a href="<%= request.getContextPath() %>/deleteBrand?id=<%= b.getBrandId() %>" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
                <%
                    }
