...
public class ReviewServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (user == null) {
            response.sendRedirect("authenticator_authorization/login.jsp");
            return;
        }
        ...
        boolean success = userDAO.addReview(user.getUserId(), productId, rating, comment);

        if (success) {
            response.sendRedirect("productdetail?productId=" + productId);
        } else {
            response.getWriter().println("Lỗi khi thêm đánh giá!");
        }
